...
import { Calendar, User, Phone, BookOpen, Clock, ChevronRight } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-1/2 space-y-10">
            ...
            >
              ...
              <h1 className="font-heading text-7xl md:text-9xl text-white tracking-tighter leading-none mb-8">
                BOOK YOUR <br />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                ...
                <div key={idx} className="flex gap-4 p-6 glass rounded-2xl border-white/5">
                  ...
                  <div>
                    <h4 className="font-heading text-xl text-white tracking-widest">{item.title}</h4>
            ...
            <div className="glass p-8 rounded-3xl border-brand-gold/20">
          ...
          <div className="lg:w-1/2 w-full">
            <div className="glass p-12 rounded-[2.5rem] border-white/5 shadow-[0_0_50px_rgba(214,40,40,0.1)] relative">
                <AnimatePresence mode="wait">
                    {!submitted ? (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -20 }}
                        >
                            <h3 className="font-heading text-4xl text-white mb-10 tracking-widest underline decoration-brand-red decoration-4 underline-offset-8">RESERVE YOUR MAT SPACE</h3>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button type="submit" className="w-full px-12 py-5 bg-brand-red text-white font-heading text-3xl tracking-widest hover:bg-brand-gold hover:text-brand-black transition-all flex items-center justify-center gap-4 group mt-8">
                        ...
                        >
                            ...
                            <h3 className="font-heading text-5xl text-white tracking-widest uppercase italic">RESERVATION RECEIVED!</h3>
