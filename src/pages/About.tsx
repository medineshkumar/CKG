...
export default function About() {
  return (
    <div className="bg-brand-black">
      {/* Page Hero */}
      <section className="relative flex items-center justify-center overflow-hidden px-6 py-8 md:py-10 lg:py-12 h-[32vh] md:h-[36vh] lg:h-[40vh]">
        <img 
        ...
        <div className="relative z-10 text-center max-w-5xl">
          <motion.h1 
            ...
            className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-6xl font-extrabold text-white tracking-tighter uppercase leading-none"
          >
            THE SPIRIT OF <span className="text-brand-red text-stroke">GUAN</span>
          </motion.h1>
          <p className="text-brand-gold font-heading text-base md:text-lg font-bold tracking-[0.5em] uppercase mt-6 opacity-80">Heritage • Discipline • Power</p>
        </div>
      </section>
      ...
      <section className="py-20 container mx-auto max-w-7xl px-6">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          <div className="lg:w-1/2">
            <h2 className="font-heading text-3xl md:text-4xl lg:text-3xl text-white mb-8">OUR LEGACY IN BANGALORE</h2>
        ...
        <div className="container mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12">
            ...
            >
              ...
              <h3 className="font-heading text-3xl md:text-4xl text-white mb-6">OUR MISSION</h3>
