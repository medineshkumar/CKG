...
export default function About() {
  return (
    <div className="pt-24 bg-brand-black">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <motion.h1 
            ...
            className="font-heading text-7xl md:text-8xl lg:text-[10rem] font-extrabold text-white tracking-tighter uppercase leading-none"
          >
            THE SPIRIT OF <span className="text-brand-red text-stroke">GUAN</span>
          </motion.h1>
          <p className="text-brand-gold font-heading text-xl md:text-2xl font-bold tracking-[0.5em] uppercase mt-6 opacity-80">Heritage • Discipline • Power</p>
        </div>
      </section>
      ...
      <section className="py-32 container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-1/2">
            <h2 className="font-heading text-6xl text-white mb-8">OUR LEGACY IN BANGALORE</h2>
          ...
          <div className="lg:w-1/2 grid grid-cols-2 gap-4">
            ...
            <div className="aspect-square rounded-2xl overflow-hidden glass p-2 mt-12">
      ...
      <section className="py-32 bg-white/5">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div 
              whileHover={{ y: -10 }}
              className="glass p-12 rounded-3xl border-brand-red/20"
            >
              <Target className="text-brand-red mb-8" size={64} />
              <h3 className="font-heading text-5xl text-white mb-6">OUR MISSION</h3>
            ...
            <motion.div 
              whileHover={{ y: -10 }}
              className="glass p-12 rounded-3xl border-brand-gold/20"
            >
              <Eye className="text-brand-gold mb-8" size={64} />
              <h3 className="font-heading text-5xl text-white mb-6">OUR VISION</h3>
              <p className="text-gray-400 text-lg leading-relaxed">
      ...
      {/* Values */}
      <section className="py-32 container mx-auto px-6">
        <h2 className="font-heading text-6xl text-white mb-16 text-center tracking-tighter italic">CORE PILLARS OF THE GUAN</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="text-center space-y-6 flex flex-col items-center">
              ...
              <h4 className="font-heading text-3xl tracking-[0.2em] text-white italic">{val.title}</h4>
            </div>
          ))}
        </div>
      </section>
