    ...
    <div className="bg-brand-black min-h-screen">
      <section className="py-20 container mx-auto px-6">
        <div className="text-center mb-20">
          <h1 className="font-heading text-7xl md:text-7xl text-white tracking-tighter mb-6 underline decoration-brand-red decoration-8">CONTACT US</h1>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 leading-relaxed">Central Kungfu Guan, No. 12,Ramanjanappa Layout,<br />4th Cross, 5th Main Rd, B Narayanapura, Bangalore - 560016</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+91 77950 12123</p>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">info.centralkungfu@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              {/* <div className="flex gap-4">
                {[Instagram, Facebook, Youtube].map((Icon, idx) => (
                  <a key={idx} href="https://www.instagram.com/lai_yin_fu/" className="w-12 h-12 bg-white/5 hover:bg-brand-red border border-white/10 transition-all rounded-full flex items-center justify-center text-white">
                    <Icon size={20} />
                  </a>
                ))}
              </div> */}
              <div className="flex gap-4">
  {[
    { Icon: Instagram, url: "https://www.instagram.com/lai_yin_fu/" },
    { Icon: Facebook, url: "https://www.facebook.com/centralkungfu" },
    { Icon: Youtube, url: "https://www.youtube.com/@centralkung-fuguan-4777" }
  ].map((social, idx) => (
    <a key={idx} href={social.url} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 hover:bg-brand-red border border-white/10 transition-all rounded-full flex items-center justify-center text-white">
      <social.Icon size={20} />
    </a>
  ))}
</div>
              ...
              <form className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input type="text" placeholder="Dinesh Kumar R" className="w-full bg-white/5 border border-white/10 px-6 py-4 rounded-xl text-white outline-none focus:border-brand-red transition-colors" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-gray-500">Contacting For</label>
                  <select className="w-full bg-white/5 border border-white/10 px-6 py-4 rounded-xl text-white outline-none focus:border-brand-red transition-colors appearance-none">
                    <option className="bg-brand-black">General Enquiry</option>
                    ...
                    <option className="bg-brand-black">Corporate Training</option>
                  </select>
                </div>
                ...
                <button className="w-full md:w-auto px-12 py-5 bg-brand-red text-white font-heading text-2xl tracking-widest hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-4">
