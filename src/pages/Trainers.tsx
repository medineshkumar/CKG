    ...
    <div className="pt-24 bg-brand-black min-h-screen">
      <section className="py-20 container mx-auto px-6">
        <div className="text-center mb-20">
          <h1 className="font-heading text-7xl md:text-9xl text-white tracking-tighter mb-6 underline decoration-brand-gold decoration-4">MEET THE MASTERS</h1>
          <p className="text-brand-red font-heading text-2xl tracking-[0.3em] uppercase">Certified Instructors • Proven Results</p>
        </div>
            ...
            >
              ...
              <div className="p-8 space-y-4">
                <div className="space-y-1">
                  <h3 className="font-heading text-3xl text-white tracking-widest">{trainer.name}</h3>
                  <p className="text-brand-gold font-heading text-xl italic">{trainer.role}</p>
                </div>
                ...
                <div className="space-y-4 border-t border-white/5 pt-4">
                  ...
                  <p className="text-gray-500 text-xs italic leading-relaxed pt-2">
                    "{trainer.bio}"
                  </p>
                </div>
              </div>
      ...
      {/* Philosophy Banner */}
      <section className="py-20 bg-[#080808] border-y border-brand-red/10">
        <div className="container mx-auto px-6 text-center italic">
          <Star className="text-brand-gold mx-auto mb-8" size={48} />
          <h2 className="font-heading text-4xl md:text-5xl text-white tracking-widest max-w-4xl mx-auto leading-normal">
